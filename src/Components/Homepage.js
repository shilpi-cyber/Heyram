                ...
                <div className='row text-center gen-z  '>
                    <div className='col-md-12 d-flex justify-content-center'>
                        <div className='card-home'>
                            ...
                            <Zoom><Link to='/career'><button className='btn bg-primary dark text-white w-50  m2-5 p-3  ' >DISCOVER NOW</button></Link></Zoom>
                        </div>
                    </div>
                </div>
                <div className='row text-center digital-row p-4 '>
                    <div className='col-md-12 d-flex justify-content-center'>
                        <div className='card-dig'>
                            ...
                            <Zoom><Link to='/digital'><button className='btn bg-primary dark text-white w-50  m2-5 p-3  ' >DISCOVER NOW</button></Link></Zoom>
                        </div>
                    </div>
                </div>
